...
const displayVideos= (videos)=>{
    ...
    <img
      src=${video.thumbnail} class="w-full h-full object-cover rounded-lg"
      alt="Shoes" />
      ${video.others.posted_date?.length === 0 ? "" : `<span class="absolute right-2 bottom-2 text-white bg-black text-xs"> ${getTimeString(video.others.posted_date)} </span>`}
